...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('core_values', function (Blueprint $table) {
            ...
            $table->tinyInteger('quarter')->unsigned(); // 1, 2, 3, 4
            ...
            // Unique constraint to prevent duplicate entries per student per core value per quarter
            $table->unique(['student_id', 'core_value', 'quarter', 'school_year_id'], 'unique_core_value_per_quarter');
