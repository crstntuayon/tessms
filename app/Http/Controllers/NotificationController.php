...
class NotificationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $dbNotifications = $user->notifications()->get()->map(function ($n) {
            $data = $n->data ?? [];
        ...
        $announcementNotifications = $announcementsQuery->get()->map(function ($ann) use ($user) {
    ...
    public function markAllAsRead(): JsonResponse
    {
        ...
        foreach ($announcementsQuery->get() as $announcement) {
            $announcement->markAsReadBy($user->id);
        }
