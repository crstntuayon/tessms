...
public function storeIssue(Request $request)
{
    ...
    $existingBook = Book::where('student_id', $request->student_id)
    ...
    if ($existingBook) {
        return back()->with('error', 'Student already has this book issued and not yet returned.');
    }
    ...
    // Update inventory
    $inventory->decrement('available_copies');
    $inventory->increment('issued_copies');
...
public function inventory(Request $request)
{
    ...
    if ($selectedSection && $selectedSection->gradeLevel) {
