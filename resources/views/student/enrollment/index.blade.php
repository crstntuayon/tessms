                                ...
                                <form action="{{ route('student.enrollment.store') }}" method="POST" class="space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <select name="grade_level_id" required
                                                class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none cursor-pointer transition-all">
                                            <option value="">Select Grade Level</option>
                                            @foreach($gradeLevels as $grade)
                                                <option value="{{ $grade->id }}" @selected(old('grade_level_id') == $grade->id || $student->grade_level_id == $grade->id)>
                                                    {{ $grade->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                        <p class="text-xs text-slate-500 mt-1">
                                            ...
                                            Select the grade level for the new school year
                                        </p>
                                    </div>
