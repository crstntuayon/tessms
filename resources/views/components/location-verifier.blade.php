...
<div x-data="locationVerifier()" x-init="init()" class="space-y-4">
    ...
    <div class="bg-white rounded-xl shadow-sm border-2 p-4 transition-all"
        ...
        <div class="flex items-center justify-between">
            ...
            <button @click="verifyLocation()" 
                    ...
                    class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition flex items-center space-x-2">
                <i x-show="loading" class="fas fa-spinner fa-spin"></i>
                <i x-show="!loading" class="fas fa-location-arrow"></i>
    ...
    {{-- Map Preview (when location obtained) --}}
