...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We are pleased to inform you that <strong>{{ $application->student_full_name }}</strong> has been officially enrolled at Tugawe Elementary School!</p>
            ...
            <div class="credentials-box">
                ...
                <p style="margin-bottom: 0;"><strong>Login Portal:</strong> <a href="{{ url('/student/login') }}">{{ url('/student/login') }}</a></p>
            </div>
            ...
            <p style="text-align: center; margin: 30px 0;">
                <a href="{{ url('/student/login') }}" class="button">Login to Student Portal</a>
            </p>
        ...
        <div class="footer">
            ...
            <p>&copy; {{ date('Y') }} Tugawe Elementary School. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
