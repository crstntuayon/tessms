...
<head>
    ...
    <title>Create User - Admin Only - Tugawe Elem</title>
    <!-- Font Awesome 6 CDN -->
    ...
    <div class="main-wrapper">
        ...
        <header class="main-header">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.users.index') }}" class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-slate-200 transition-all">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Create a new system user with administrative privileges</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <main class="main-content">
            ...
            <div class="mb-6 p-4 alert-warning rounded-xl flex items-center gap-3 animate-fade-in-up shadow-sm">
                ...
                <div>
                    <p class="text-amber-800 font-semibold text-sm">Administrator Access Required</p>
                    <p class="text-amber-700 text-sm">You are creating a user with system access. Please verify all information before proceeding.</p>
                </div>
            </div>
...
<div class="glass-card p-6 animate-fade-in-up">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <input type="hidden" name="name" id="fullNameField" value="{{ old('name') }}">
        ...
        <div>
            ...
            <div class="input-group">
                <input type="text" 
                       ...
                       class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('first_name') border-red-300 @enderror @error('name') border-red-300 @enderror"
        ...
        <div>
            ...
            <div class="input-group">
                <input type="text" 
                       ...
                       id="lastName"
                       value="{{ old('last_name') }}"
                       class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('last_name') border-red-300 @enderror"
        ...
        <div>
            ...
            <div class="input-group">
                <input type="text" 
                       name="username" 
                       value="{{ old('username') }}"
                       class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('username') border-red-300 @enderror"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="input-group">
                                        <input type="email" 
                                               name="email" 
                                               value="{{ old('email') }}"
                                               class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('email') border-red-300 @enderror"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="input-group">
                                        <select name="role_id" 
                                                id="roleSelect"
                                                class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('role_id') border-red-300 @enderror"
...
<div>
    ...
    <div class="input-group">
        <select name="status" 
                class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon appearance-none cursor-pointer @error('status') border-red-300 @enderror"
                required>
    ...
    @enderror
                                ...
                                <div>
                                    ...
                                    <div class="input-group">
                                        <input type="password" 
                                               name="password" 
                                               id="password"
                                               class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('password') border-red-300 @enderror"
                        ...
                        <div class="glass-card p-6 animate-fade-in-up animate-delay-2">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    <h2 class="font-bold text-slate-900">Admin Notes</h2>
                                    <p class="text-xs text-slate-500">Internal notes (only visible to admins)</p>
                                </div>
                            </div>
