...
<head>
    ...
    <title>Edit User - Tugawe Elem</title>
    <!-- Font Awesome 6 CDN -->
            ...
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-0.5">Update user information</p>
                    </div>
                </div>
            </div>
        </header>
                        ...
                        <div class="text-center">
                            ...
                            <div class="pt-4 border-t border-slate-100 text-left space-y-3">
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <span class="font-semibold text-slate-900">{{ $user->created_at->format('M d, Y') }}</span>
                                </div>
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-slate-500">Last Updated</span>
                                    <span class="font-semibold text-slate-900">{{ $user->updated_at->format('M d, Y') }}</span>
                                </div>
                                <div class="flex items-center justify-between text-sm">
                                ...
                                <div>
                                    ...
                                    <div class="input-group">
                                        <input type="text" 
                                               ...
                                               class="form-input w-full px-4 py-2.5 rounded-xl text-sm has-icon @error('first_name') border-red-300 @enderror"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <div class="input-group">
                                        <textarea name="address" 
                                                  rows="3"
                                                  class="form-input w-full px-4 py-2.5 rounded-xl text-sm @error('address') border-red-300 @enderror"
                        ...
                        <div class="glass-card p-6 animate-fade-in-up animate-delay-2">
                            <div class="flex items-center gap-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500">Manage role and status</p>
                                </div>
                            </div>
