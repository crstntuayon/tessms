            ...
            <div class="max-w-5xl mx-auto pb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-fade-in stagger-1">
                    <div class="stat-card">
                        ...
                        <p class="text-sm font-semibold text-slate-600">Students</p>
                        <div class="mt-3">
                    ...
                    <table class="modern-table w-full">
                        ...
                        <tbody>
                            @forelse($section->students as $student)
                                <tr>
                                    <td>
                                        <span class="text-sm font-semibold text-slate-400">#{{ $loop->iteration }}</span>
                                    </td>
                                    <td>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="font-semibold text-slate-900">{{ $student->full_name ?? $student->first_name . ' ' . $student->last_name }}</p>
                                    ...
                                    <td>
                                        <span class="status-badge {{ ($student->status ?? 'active') === 'active' ? 'status-active' : 'status-inactive' }}">
                                            <i class="fas fa-circle text-[8px]"></i>
                                            {{ ucfirst($student->status ?? 'active') }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="text-sm text-slate-700">{{ $student->created_at->format('M d, Y') }}</span>
                                        <p class="text-xs text-slate-400">{{ $student->created_at->diffForHumans() }}</p>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <div class="empty-state">
                                            ...
                                            <h3 class="text-lg font-bold text-slate-900 mb-2">No Students Yet</h3>
                                            <p class="text-slate-500 mb-6 max-w-md mx-auto">This section doesn't have any enrolled students yet. Add students to get started.</p>
