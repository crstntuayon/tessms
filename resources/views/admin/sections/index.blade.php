            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 animate-fade-in">
                <div class="stat-card">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-slate-900">{{ $sections->count() }}</span>
                    </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-slate-900">{{ $sections->whereNotNull('teacher_id')->count() }}</span>
                    </div>
                ...
                <div class="stat-card">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <span class="text-2xl font-bold text-slate-900">{{ $sections->whereNull('teacher_id')->count() }}</span>
                    </div>
                ...
                <div class="flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        ...
                        @foreach($gradeLevels ?? [] as $grade)
                            <button class="filter-pill">Grade {{ $grade->level }}</button>
                        @endforeach
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="flex flex-col gap-2">
                                        @if($section->gradeLevel)
                                            <span class="grade-badge">
                                                ...
                                                {{ $section->gradeLevel->name ?? 'Grade ' . $section->gradeLevel->level }}
                                            </span>
                                        @else
                                        ...
                                        @if($section->teacher)
                                            <span class="adviser-badge">
                                                ...
                                                {{ $section->teacher->full_name ?? $section->teacher->first_name . ' ' . $section->teacher->last_name }}
                                            </span>
                                        @else
                                ...
                                <td>
                                    <div class="w-36">
                                        <div class="flex justify-between text-xs mb-1">
                                            ...
                                            <span class="text-slate-400">{{ round($percentage) }}%</span>
                                        </div>
                                ...
                                <td>
                                    <div class="flex items-center gap-3">
                                        <div class="flex -space-x-2">
                                            @for($i = 0; $i < min(3, $studentCount); $i++)
