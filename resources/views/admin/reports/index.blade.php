    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="space-y-3">
                    <a href="{{ route('admin.reports.builder', ['template' => 'student-masterlist']) }}" 
                    ...
                    <a href="{{ route('admin.reports.builder', ['template' => 'grade-summary']) }}" 
                    ...
                    <a href="{{ route('admin.reports.builder', ['template' => 'attendance-summary']) }}" 
                    ...
                    <a href="{{ route('admin.reports.builder', ['template' => 'honor-roll']) }}" 
...
<script>
    ...
    function runSavedReport(reportId) {
        window.location.href = `/admin/reports/saved/${reportId}/run`;
    }
</script>
@endpush
