            ...
            <main class="main-content">
                ...
                <div class="glass-card overflow-hidden animate-fade-in-up" style="animation-delay: 0.1s;">
                    <div class="p-6 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-slate-50/80 to-white">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500">Showing <span class="font-semibold text-purple-600">{{ $teachers->count() }}</span> teaching staff members</p>
                            </div>
                        </div>
                    ...
                    <div class="px-6 py-5 border-t border-slate-200 bg-gradient-to-r from-slate-50/50 to-white flex items-center justify-between">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm font-bold text-slate-900 bg-white px-3 py-1 rounded-lg border border-slate-200">{{ $teachers->count() }}</span>
                            <span class="text-sm text-slate-500">of {{ $teachers->count() }} teachers</span>
                        </div>
                        
                        <div class="flex items-center gap-2">
                            <button class="px-4 py-2.5 text-sm font-semibold text-slate-400 cursor-not-allowed border border-slate-200 rounded-xl bg-slate-50" disabled>
                                <i class="fas fa-chevron-left mr-1.5"></i>
                                Previous
                            </button>
                            <div class="flex items-center gap-1">
                                <button class="w-10 h-10 rounded-xl bg-purple-600 text-white font-semibold text-sm shadow-lg shadow-purple-500/30">1</button>
                                <button class="w-10 h-10 rounded-xl bg-white text-slate-600 font-semibold text-sm border border-slate-200 hover:border-purple-300 hover:text-purple-600 transition-all">2</button>
                                <button class="w-10 h-10 rounded-xl bg-white text-slate-600 font-semibold text-sm border border-slate-200 hover:border-purple-300 hover:text-purple-600 transition-all">3</button>
                            </div>
                            <button class="px-4 py-2.5 text-sm font-semibold text-slate-600 hover:text-purple-600 hover:bg-purple-50 border border-slate-200 hover:border-purple-200 rounded-xl transition-all bg-white shadow-sm">
                                Next
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8 animate-fade-in-up" style="animation-delay: 0.2s;">
                    @php
                        ...
                        $activeTeachers = $statusDistribution['active'] ?? 0;
                        $onLeaveTeachers = $statusDistribution['on_leave'] ?? 0;
                        $totalSections = $teachers->flatMap->sections->unique('id')->count();
                    @endphp
                    ...
                    <div class="stat-card">
                        ...
                        <div>
                            <p class="text-3xl font-bold text-slate-900">{{ $activeTeachers }}</p>
                            ...
                            <div class="mt-2 flex items-center gap-1 text-xs text-emerald-600 font-semibold">
                                ...
                                <span>{{ $teachers->count() > 0 ? round(($activeTeachers / $teachers->count()) * 100) : 0 }}% of total</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="stat-card">
                        ...
                        <div>
                            <p class="text-3xl font-bold text-slate-900">{{ $onLeaveTeachers }}</p>
                    ...
                    <div class="stat-card">
                        ...
                        <div>
                            <p class="text-3xl font-bold text-slate-900">{{ $subjectCount }}</p>
                    ...
                    <div class="stat-card">
                        ...
                        <div>
                            <p class="text-3xl font-bold text-slate-900">{{ $totalSections }}</p>
