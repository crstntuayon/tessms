...
<body class="text-slate-800 antialiased">
    ...
    <div class="main-wrapper" id="mainWrapper">
        <div class="main-content">
                ...
                <div class="relative z-10">
                    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                <h1 class="text-3xl lg:text-4xl font-bold tracking-tight">{{ $teacher->first_name }} {{ $teacher->last_name }}</h1>
                                <p class="text-blue-200 mt-2 text-base lg:text-lg">Teacher Account • ID: {{ $teacher->employee_id }}</p>
                            </div>
                        </div>
                        <div class="flex flex-wrap items-center gap-4">
                            ...
                            <div class="text-sm text-blue-200">
                                ...
                                Last updated: {{ $teacher->updated_at ? $teacher->updated_at->format('M d, Y h:i A') : 'Never' }}
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="font-semibold">{{ $teacher->employee_id }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="font-semibold truncate">{{ $teacher->email }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-4 border border-white/20">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="font-semibold">{{ $teacher->user->username ?? 'N/A' }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="glass-card p-6 lg:p-8 animate-fade-in stagger-2">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="bg-gradient-to-r from-indigo-50 to-blue-50 border border-indigo-200 rounded-xl p-4 flex items-center gap-3">
                                    ...
                                    <div class="flex-1">
                                        <div class="font-mono font-bold text-indigo-700 text-lg">{{ $teacher->user->username ?? 'N/A' }}</div>
                                        <div class="text-xs text-indigo-500">Linked to user account #{{ $teacher->user_id ?? $teacher->user->id ?? 'N/A' }}</div>
                                    </div>
                                ...
                                <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-semibold text-sm">{{ $teacher->last_login_at ? $teacher->last_login_at->format('M d, Y h:i A') : 'Never' }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-semibold text-sm">{{ $teacher->created_at ? $teacher->created_at->format('M d, Y') : 'N/A' }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-semibold text-sm">{{ $teacher->updated_by ?? 'System' }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="bg-slate-50 rounded-xl p-4 border border-slate-200">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="font-semibold text-sm">{{ $teacher->password_changed_at ? $teacher->password_changed_at->format('M d, Y') : 'Never' }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Hidden Delete Form -->
            <form action="{{ route('admin.teachers.destroy', $teacher->id) }}" method="POST" id="deleteForm" style="display: none;">
                @csrf
                @method('DELETE')
            </form>
        </div>
