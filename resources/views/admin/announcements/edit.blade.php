        ...
        <div class="p-6 border-b border-slate-100">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="scope" x-model="scope" @change="onScopeChange()" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-white">
                ...
                <div x-show="scope === 'section'" x-transition>
                    ...
                    <select name="target_id" x-model="targetId" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm bg-white">
...
function announcementForm() {
    return {
        ...
        validateForm() {
            ...
            if ((this.scope === 'section' || this.scope === 'grade') && !this.targetId) { alert('Please select a target section or grade level.'); return false; }
            return true;
        }
    }
}
