...
<body class="bg-slate-50 text-slate-800 antialiased">
    ...
    <div class="fab-container">
        {{-- Cancel Button --}}
        <a href="{{ route('teacher.profile') }}" class="fab-btn fab-cancel">
            <i class="fas fa-times text-xl"></i>
            <span class="fab-tooltip">Cancel</span>
        </a>
        
        {{-- Save Button --}}
        <button type="submit" form="profile-form" class="fab-btn fab-save">
            <i class="fas fa-save text-xl"></i>
            <span class="fab-tooltip">Save Changes</span>
        </button>
    </div>
