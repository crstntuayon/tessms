                    ...
                    <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                ...
                                <p class="text-base font-bold text-slate-800">{{ $user->first_name }} {{ $user->middle_name }} {{ $user->last_name }} {{ $user->suffix }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
...
<div class="info-card bg-white rounded-2xl p-5 shadow-sm">
    ...
    <p class="text-base font-bold text-slate-800 flex items-center gap-2">
        ...
        {{ $display }}
                            ...
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                ...
                                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-bold {{ $user->is_active ? 'bg-emerald-100 text-emerald-700 border border-emerald-200' : 'bg-red-100 text-red-700 border border-red-200' }}">
                                    <span class="w-2 h-2 rounded-full {{ $user->is_active ? 'bg-emerald-500 status-pulse' : 'bg-red-500' }} mr-2"></span>
                    ...
                    <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                ...
                                <p class="text-base font-bold text-slate-800 font-mono">{{ $teacher->deped_id ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Full Name</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->first_name ?? '' }} {{ $teacher->middle_name ?? '' }} {{ $teacher->last_name ?? '' }} {{ $teacher->suffix ?? '' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Date of Birth</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->date_of_birth ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Place of Birth</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->place_of_birth ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Gender</p>
                                <p class="text-base font-bold text-slate-800 capitalize">{{ $teacher->gender ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Civil Status</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->civil_status ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Nationality</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->nationality ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Religion</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->religion ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                    ...
                    <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            ...
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                ...
                                <p class="text-base font-bold text-slate-800">{{ $teacher->designation ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Department</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->department ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                ...
                                <p class="text-base font-bold text-slate-800">{{ $teacher->highest_education ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Degree Program</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->degree_program ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Major</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->major ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Minor</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->minor ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">School Graduated</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->school_graduated ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Year Graduated</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->year_graduated ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">PRC License Number</p>
                                <p class="text-base font-bold text-slate-800 font-mono bg-slate-100 px-3 py-1.5 rounded-lg inline-block">{{ $teacher->prc_license_number ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">PRC Validity</p>
                                <p class="text-base font-bold text-slate-800">{{ $teacher->prc_license_validity ?? 'N/A' }}</p>
                            </div>
                            <div class="info-card bg-white rounded-2xl p-5 shadow-sm">
    ...
    {{-- Icon-Only Floating Action Button with Tooltip --}}
    <div class="fab-container fixed bottom-6 right-6 z-50">
        <a href="{{ route('teacher.profile.edit') }}" class="fab-icon w-14 h-14 rounded-full gradient-bg flex items-center justify-center text-white text-xl z-50 relative">
