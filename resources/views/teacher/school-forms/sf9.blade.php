...
<body class="bg-gray-200 min-h-screen" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
    ...
    <!-- Main Content -->
    <div class="lg:ml-72 p-6 transition-all duration-300" id="main-content">
