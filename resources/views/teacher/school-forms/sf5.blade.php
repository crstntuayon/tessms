...
<body class="bg-slate-100 min-h-screen" x-data="{ mobileOpen: false }" @keydown.escape.window="mobileOpen = false">
    ...
    <div class="lg:ml-72 p-6">
        ...
        <div class="no-print mb-4 bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <form method="GET" action="{{ route('teacher.sf5') }}" class="flex items-end gap-4">
                <div class="flex-1">
        ...
        <!-- SF5 Container -->
        <div class="sf5-container bg-white p-4 rounded-xl shadow-lg border border-slate-200 max-w-[1600px] mx-auto">
                    ...
                    <table class="summary-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="font-bold text-[9px]">{{ $malePromoted > 0 ? $malePromoted : '' }}</td>
                                <td class="font-bold text-[9px]">{{ $femalePromoted > 0 ? $femalePromoted : '' }}</td>
                                <td class="font-bold text-[9px]">{{ ($malePromoted + $femalePromoted) > 0 ? ($malePromoted + $femalePromoted) : '' }}</td>
                            </tr>
                            <tr>
                                <td class="text-left text-[8px] pl-2">*CONDITIONAL</td>
                                <td class="font-bold text-[9px]">{{ $maleConditional > 0 ? $maleConditional : '' }}</td>
                                <td class="font-bold text-[9px]">{{ $femaleConditional > 0 ? $femaleConditional : '' }}</td>
                                <td class="font-bold text-[9px]">{{ ($maleConditional + $femaleConditional) > 0 ? ($maleConditional + $femaleConditional) : '' }}</td>
                            </tr>
                            <tr>
                                <td class="text-left text-[8px] pl-2">RETAINED</td>
                                <td class="font-bold text-[9px]">{{ $maleRetained > 0 ? $maleRetained : '' }}</td>
                                <td class="font-bold text-[9px]">{{ $femaleRetained > 0 ? $femaleRetained : '' }}</td>
                                <td class="font-bold text-[9px]">{{ ($maleRetained + $femaleRetained) > 0 ? ($maleRetained + $femaleRetained) : '' }}</td>
                            </tr>
                            <tr class="bg-gray-100 font-bold">
                                <td class="text-left text-[8px] pl-2">TOTAL</td>
                                <td class="text-[9px]">{{ $maleCounter > 0 ? $maleCounter : '' }}</td>
                                <td class="text-[9px]">{{ $femaleCounter > 0 ? $femaleCounter : '' }}</td>
                                <td class="text-[9px]">{{ $totalStudents > 0 ? $totalStudents : '' }}</td>
                            </tr>
                        </tbody>
                    </table>
