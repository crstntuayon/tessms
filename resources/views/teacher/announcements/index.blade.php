        ...
        <div class="px-6 py-4 bg-white border-b border-slate-100 shrink-0">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="bg-indigo-50 rounded-xl p-4 border border-indigo-100">
                    ...
                    <p class="text-2xl font-bold text-indigo-900 mt-1">{{ $announcements->total() }}</p>
                </div>
                <div class="bg-amber-50 rounded-xl p-4 border border-amber-100">
                    <p class="text-xs font-semibold text-amber-600 uppercase tracking-wider">Pinned</p>
                    <p class="text-2xl font-bold text-amber-900 mt-1">{{ $announcements->where('pinned', true)->count() }}</p>
                </div>
                <div class="bg-emerald-50 rounded-xl p-4 border border-emerald-100">
                    <p class="text-xs font-semibold text-emerald-600 uppercase tracking-wider">Total Reads</p>
                    <p class="text-2xl font-bold text-emerald-900 mt-1">{{ $announcements->sum('reads_count') }}</p>
                </div>
                <div class="bg-rose-50 rounded-xl p-4 border border-rose-100">
                    ...
                    <p class="text-2xl font-bold text-rose-900 mt-1">{{ $announcements->where('priority', 'urgent')->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 overflow-y-auto p-6">
            ...
            @if($announcements->isEmpty())
                <div class="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <p class="text-sm text-slate-400 mt-1 max-w-sm">Create your first announcement to reach your students instantly.</p>
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <div class="flex items-center gap-2 mb-1 flex-wrap">
                                            ...
                                            <span class="px-2 py-0.5 bg-indigo-50 text-indigo-600 text-[10px] font-bold rounded-full uppercase tracking-wide">
                                                {{ str_replace('_', ' ', $announcement->scope) }}
                                            </span>
                                        </div>
