...
<head>
    ...
    <style>
        * {
        ...
        .fab-save:hover {
            box-shadow: 0 15px 45px -5px rgba(79, 70, 229, 0.5);
        }
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="flex flex-col md:flex-row gap-6 mb-6">
                                ...
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <a href="{{ route('teacher.profile.edit') }}" class="text-sm font-semibold text-primary-600 hover:text-primary-700 transition-colors">
                                        Edit in Profile
                                    </a>
                                </div>
                        ...
                        <div class="glass-card rounded-3xl p-5 lg:p-8 shadow-lg border border-white/60">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div class="space-y-2">
                                    ...
                                    <select name="settings[theme]" class="select-field w-full px-4 py-3 rounded-xl bg-white text-sm font-semibold text-slate-800 focus:outline-none">
...
<div class="fab-container">
    {{-- Back/Return Button --}}
    <a href="{{ route('teacher.dashboard') }}" class="fab-btn fab-danger" style="text-decoration: none;">
        <i class="fas fa-arrow-left text-xl"></i>
        <span class="fab-tooltip">Back to Dashboard</span>
    </a>
    
    {{-- Reset Button --}}
    <button type="button" onclick="resetForm()" class="fab-btn fab-danger">
        <i class="fas fa-undo text-xl"></i>
        <span class="fab-tooltip">Reset Changes</span>
    </button>
    
    {{-- Save Button --}}
    <button type="button" onclick="saveSettings()" id="save-btn" class="fab-btn fab-save">
        <i class="fas fa-save text-xl"></i>
        <span class="fab-tooltip">Save Settings</span>
    </button>
</div>
